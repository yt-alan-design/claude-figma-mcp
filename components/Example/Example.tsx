...
export default function Example() {
  return (
    <div className={styles.example}>
      {/* Content group: text + image */}
      <div className={styles.contentGroup}>
        <div className={styles.textGroup}>
          <p className={styles.heading}>Hello, MCP Design</p>
          <p className={styles.body}>
            Code Connect is a bridge between your codebase and Figma&apos;s Dev
            Mode, connecting components in your repositories directly to
            components in your design files. When implemented, these connections
            enhance the{" "}
            <a href="https://developers.figma.com/docs/figma-mcp-server">
              Figma MCP server
            </a>
            &apos;s ability to guide AI agents with more precise implementation
            details by giving them direct references to your actual code.
          </p>
        </div>
      ...
      <button className={styles.circularButton} aria-label="Favorite">
        <svg
          width="24"
          height="24"
